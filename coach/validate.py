...
# Помимо фиксированных триггеров ниже покрыты морфологические варианты
# («привёл/привела/привело», «объясняется», «вызвано», «следствие») и
# обобщённый паттерн «результат <дрилла/тренировки/упражнения/практики>»
# (не только буквальное «дал результат»).
